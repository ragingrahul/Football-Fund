      ...
      >
        <Providers>
          <div className="container flex min-h-[100dvh] flex-row px-0">
            <div className="hidden h-[100dvh] justify-between border-r border-r-border p-4 md:flex md:w-[360px] md:shrink-0 md:flex-col">
              <MainNav />
            </div>
            <main className="max-w-[70vw] flex-1">
              <div className="flex h-16 items-center justify-between border-b border-b-border p-4 md:hidden">
                <MobileNav />
                <Image src="/logo2.png" width={105} height={32} alt="logo" className='ml-12' />
            ...
            <div className="hidden border-l border-l-border md:flex md:w-[380px] md:flex-col">
              <BetSlip />
            </div>
          </div>
          <GoogleTag />
