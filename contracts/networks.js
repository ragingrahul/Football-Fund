...
const networks = {
  ...
  optimismSepolia: {
    ...
    gasPrice: undefined, // for spikes and higher L2 prices.
    accounts: PRIVATE_KEY !== undefined ? [PRIVATE_KEY] : [],
  ...
  arbitrumSepolia:{
    ...
    gasPrice: undefined,
    accounts: PRIVATE_KEY!== undefined? [PRIVATE_KEY] : [],
    verifyApiKey: process.env.ARBI_ETHERSCAN_API_KEY || "UNSET",
    chainId: 421614,
    confirmations: DEFAULT_VERIFICATION_BLOCK_CONFIRMATIONS,
    nativeCurrencySymbol: "ETH",
  ...
  openCampusSepolia:{
    url: process.env.OPEN_CAMPUS_RPC_URL || "UNSET",
    gasPrice: undefined,
    accounts: PRIVATE_KEY!== undefined? [PRIVATE_KEY] : [],
    verifyApiKey: process.env.OPEN_CAMPUS_ETHERSCAN_API_KEY || "UNSET",
    chainId: 656476,
    confirmations: DEFAULT_VERIFICATION_BLOCK_CONFIRMATIONS,
    nativeCurrencySymbol: "EDU",
