...
import {
  usePredictEduChainCalculateWinnings,
  usePredictEduChainGetGame,
  usePredictEduChainIsPredictionCorrect
} from '@/generatedEdu'
...
export default function BetCard({
  ...
  const { data: gameData } = usePredictEduChainGetGame({
  ...
  const { data: calculatedWinnings } = usePredictEduChainCalculateWinnings(
    {
      address: contractAddress,
  ...
  console.log(gameData,games,prediction)
